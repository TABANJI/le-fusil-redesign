(function appointmentExperience(global){
  ...
  form.addEventListener('submit',event=>{
    ...
    const method=form.elements.preferredContact.value,rules={fullName:{required:true,max:100},preferredContact:{required:true},email:{required:method==='Email',email:true,max:254},phone:{required:method==='Phone'||method==='WhatsApp',phone:true,max:40},country:{max:80},preferredDate:{required:true,future:true,maxDays:global.LEFUSIL_SITE_CONFIG.appointment.maxAdvanceDays},timeWindow:{required:true},notes:{min:10,max:1500}};
