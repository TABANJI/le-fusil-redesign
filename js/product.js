(function productPage(){
  ...
  mount.innerHTML=`
    ...
    <section class="product-section story-layout"><div class="story-mark"><div class="eyebrow">About This Piece</div></div><div class="story-content"><p>${escapeHtml(description)}</p></div></section>
