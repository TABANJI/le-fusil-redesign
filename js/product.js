(function productPage(){
  ...
  mount.innerHTML=`
    ...
    <section class="product-section story-layout"><div class="story-mark"><div class="eyebrow">About This Piece</div></div><div class="story-content"><h2>${escapeHtml(product.brand)} ${escapeHtml(product.name)}</h2><p>${escapeHtml(description)}</p>${product.description&&product.shortDescription&&product.description!==product.shortDescription?`<p>${escapeHtml(product.shortDescription)}</p>`:''}</div></section>
